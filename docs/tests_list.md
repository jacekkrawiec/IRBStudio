...
- `test_validate_portfolio_all_required_columns` - Check required columns present
...
- `test_scenario_target_auc_range` - `Scenario.target_auc` in [0.5, 1.0]
- `test_scenario_asset_correlation_range` - `Scenario.asset_correlation` in [0, 1]
...
- `test_portfolio_simulator_invalid_target_auc` - Error on invalid AUC
- `test_portfolio_simulator_invalid_correlation` - Error on invalid correlation
...
- `test_run_monte_carlo_basic` - `run_monte_carlo()` with n_iterations
...
### By Module
- **High-Level API:** 18 tests
- **Data Management:** 21 tests
- **Configuration System:** 26 tests
- **Monte Carlo Simulation:** 34 tests
- **RWA Calculators:** 45 tests
- **Scenario Analysis:** 39 tests
- **Reporting & Visualization:** 34 tests
- **Advanced Features:** 32 tests
...
- `run_analysis()` tests
- `PortfolioSimulator` tests
- `AIRBMortgageCalculator` tests
- `SAMortgageCalculator` tests
- `IntegratedAnalysis` tests
...
### Priority 3 (Nice to Have - Advanced/Edge Cases)
- Performance tests
- Edge case tests
